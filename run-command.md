Use this tool to run a command inside an existing Koyeb Sandbox. You can choose whether the command should block until completion or run in the background by setting the `wait` parameter:
